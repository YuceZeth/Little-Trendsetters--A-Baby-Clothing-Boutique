    ...
    <div class="container-xxl bg-white p-0">
        ...
        <div id="cart-content">
         ...
         <nav class="navbar navbar-expand-lg bg-white navbar-light px-4 px-lg-5 py-lg-0"  style="height:70px"> 
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <div class="navbar-nav mx-auto">
                    <a href='bebek_takımları.php' class='nav-item nav-link active'><font size='3'>Bebek Takımları</font></a>
        ...
        <div class="container-xxl py-5">
            <div class="container">
                <div class="text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 600px;">
                    <h1 class="mb-3"><font color="orange">Bebek Takımları</font></h1>
                </div>
                <div class="row g-4">
                    <?php 
                    $sorgu = mysqli_query($conn, "select * from urunler where urun_kategori='bebek takımları'");
                    $rs = 0;
