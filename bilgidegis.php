...
<body>
    <div class="container-xxl bg-white p-0">
        ...
        <div class="container-xxl py-5">
            <div class="container">
                <div class="text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 600px;">
					...
					<h3><p align='center'>Çıkmak için <a href='cikis.php' title='Çıkış'> buraya basınız.</p></a></h3>
					<h3><p align='center'>Hesabıma Dönmek İçin <a href='kuyegirisi.php' title='Çıkış'>Tıklayınız.</p></a></h3>
				</div>
				<div class="row g-4" style="width: 850px;">
				<?php
    				if(@$_SESSION["name"]) {
    					$id = $_SESSION['id'];
    					$gusorgu = mysqli_query($conn, "select * from uyeler where uye_id = '".$id."'");
    					while ($gudoldur = mysqli_fetch_array($gusorgu)) {
    						echo "<h2><p align='center'><font color='#FF7F00'>Hoş Geldin ".$gudoldur["uye_adsoyad"]."</font></p></h2>";
    					}
    					$bilgiler = mysqli_query($conn, "select * from uyeler where uye_id ='".$id."'");
    					while ($bdoldur = mysqli_fetch_array($bilgiler)) {
                            echo "<div class='table-wrapper' style='margin-left: 120px'>";
                            echo "<form method='post' action='bilgiisle.php' id='bilgiisle'>";
					        ...
					        echo "
                                <table class='fl-table'>
                                    ...
                                    <tbody>
                                        <tr>
                                            <td><input type='text' name='ad_soyad' value='".$bdoldur['uye_adsoyad']."'></td>
                                            <td><input type='tel' name='telefon' value='".$bdoldur['uye_telefon']."'></td>
                                            <td><input type='text' name='mail' value='".$bdoldur['uye_mail']."'></td>
                                            <td><input type='text' name='sehir' value='".$bdoldur['uye_sehir']."'></td>
                                            <td><input type='text' name='ilce' value='".$bdoldur['uye_ilce']."'></td>
                                            <td><input type='text' name='posta_kodu' value='".$bdoldur['uye_posta_kodu']."'></td>
                                            <td><textarea name='adres'>".$bdoldur['uye_adres']."</textarea></td>
                                        </tr>
                                    </tbody>
                                </table>
    						";
                        ...
                        echo "<center style='margin-left:250px;'><button id='complete-information-button' class='btn btn-primary'>Gönder</button></center>";
                        echo "<h3><p id='message'  style='color:#FF7F00;'></p></h3>";
                        echo "</form>";
    				}
				?>
				</div>
        ...
        <script type="text/javascript">
            $('#bilgiisle').submit(function(event) {
