...
<body>
    <div class="container-xxl bg-white p-0">
                        ...
                        <div class="container">
                            <div class="row justify-content-start">
                                <div class="col-10 col-lg-8">
                                    <h1 class="display-2 text-white animated slideInDown mb-4">Bebek Giyim İçin En İyi Adres</h1>
                                    <a href="contact.php" class="btn btn-primary rounded-pill py-sm-3 px-sm-5 me-3 animated slideInLeft">İletişim</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row g-0">
                        ...
                        <div class="col-lg-6 wow fadeIn" data-wow-delay="0.5s">
                            <div class="h-100 d-flex flex-column justify-content-center p-5">
                                <h1 class="mb-4"><font color="#0f7791">Alışverişe Başlayın</font></h1>
                                <a class="btn btn-primary py-3 px-5" href="bebek_takımları.php">GİT<i class="fa fa-arrow-right ms-2"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="container-xxl py-5">
            <div class="container">
                <div class="text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 600px;">
                    <h1 class="mb-3"><font color="#0f7791">Bazı Ürünler</font></h1>
                </div>
                <div class="row g-4">
                    <?php 
                    ...
                    while ($doldur = mysqli_fetch_array($sorgu)) {
                        ...
                        while ($rdoldur = mysqli_fetch_array($rsorgu)) {
                            if ($rs != 3) {
                                ...
                                echo "<ul id='product-list' style='width:430px'>
                                        ...
                                        <a href='Durunler.php?id=".$kodid."'>
                                        <img src='img/".$rdoldur['resim']."' style='width:300px ;height: 300px' alt='product' class='product-image img-fluid'>
                                        </a>
                                        </center>
        ...
        <!--<div class="container-xxl py-5">
            <div class="container">
                <div class="text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 600px;">
                    <h1 class="mb-3"><font color="#0f7791"></font></h1>
                </div>
                <div class="owl-carousel testimonial-carousel wow fadeInUp" data-wow-delay="0.1s">
                <?php 
                $sorgu = mysqli_query($conn, "select * from uyeler");
                while ($doldur = mysqli_fetch_array($sorgu)) {
                    if ($doldur['yorumgoster'] == "1") {
                        echo "<div class='testimonial-item bg-light rounded p-5'>
                            <p class='fs-5'>".$doldur['yorum']."</p>
                            <div class='d-flex align-items-center bg-white me-n5' style='border-radius: 50px 0 0 50px;'>
                            <div class='ps-3'>
                            <h3 class='mb-1'>".$doldur['uye_isim']."</h3>
                            </div>
