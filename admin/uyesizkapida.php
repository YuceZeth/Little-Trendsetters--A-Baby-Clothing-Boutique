        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                        ...
                        <?php
                            echo "<h3><font color='red'><center>ÜYESİZ KAPIDA SİPARİŞ</center></font></h3>";
                            echo "<thead>"; 
                            echo "<tr>";
                            ...
                            echo "</tr>";
                            echo "</thead>";
                            $sepet = mysqli_query($conn, "select * from uyesiz_kapida where durum='Hazırlanıyor'");
                            ...
                            while ($dsepet = mysqli_fetch_array($sepet)) {
                                ...
                                <form action='siparisislekapida.php' method='post' id='siparisisle'>
                                    <?php echo "<input type='hidden' name='id' value='".$dsepet['uyesiz_kapıda_odeme_id']."'>"; ?>
                                    <select name="durum">
                                    <?php foreach($ddurum as $durumlar): ?>
                                    <option value="<?php echo $durumlar; ?>"><?php echo $durumlar; ?></option>
                                    <?php endforeach; ?>
                                </select><?php echo "</font></td>";
                                $hsipairsid = hash('sha256', rand(1,1000)).$dsepet['uyesiz_kapıda_odeme_id'].hash('sha256', rand(1,1000));
                            echo "<td><font color='black'><center".$dsepet['uyesiz_kapıda_odeme_id']."</center></font></td>";
                            }echo "</tr>";
                            echo "</table>";
                        ?>
