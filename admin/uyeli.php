        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                        ...
                        <?php
                            echo "<h3><font color='red'><center>ÜYELİ SİPARİŞ</bluecenter></font></h3>";
                            echo "<thead>"; 
                            echo "<tr>";
                            ...
                            echo "<th><font color='blue'>Sipariş Türü</font></th>";
                            echo "</tr>";
                            echo "</thead>";
                            $sepet = mysqli_query($conn, "select * from uyeli_sepet where durum='Hazırlanıyor'");
                            ...
                            while ($dsepet = mysqli_fetch_array($sepet)) {
                                ...
                                <form action='siparisisleuyeli.php' method='post' id='siparisisle'>
                                    <input type="hidden" name="tablo" value="3">
                                    <?php echo "<input type='hidden' name='id' value='".$dsepet['uye_sepet_id']."'>"; ?>
                                    <select name="durum">
                                    <?php foreach($ddurum as $durumlar): ?>
                                    <option value="<?php echo $durumlar; ?>"><?php echo $durumlar; ?></option>
                                    <?php endforeach; ?>
                                </select><?php echo "</font></td>";
                                $hsipairsid = hash('sha256', rand(1,1000)).$dsepet['uye_sepet_id'].hash('sha256', rand(1,1000));
                            echo "<td><font color='black'><center>".$dsepet['odemeturu']."</center></font></td>";
                            }echo "</tr>";
                            echo "</table>";
                        ?>
