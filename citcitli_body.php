         ...
         <nav class="navbar navbar-expand-lg bg-white navbar-light px-4 px-lg-5 py-lg-0"  style="height:70px"> 
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <div class="navbar-nav mx-auto">
                    ...
                    <a href='citcitli_body.php' class='nav-item nav-link active'><font size='3'>Çıtçıtlı Body</font></a>
        ...
        <div class="container-xxl py-5">
            <div class="container">
                <div class="text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 600px;">
                    <h1 class="mb-3"><font color="orange">Çıtçıtlı Body</font></h1>
                </div>
                <div class="row g-4">
                    <?php 
                    $sorgu = mysqli_query($conn, "select * from urunler where urun_kategori='çıtçıtlı body'");
                    $rs = 0;
