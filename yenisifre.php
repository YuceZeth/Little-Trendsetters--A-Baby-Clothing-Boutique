        ...
        <div class="container-xxl py-5">
            <div class="container">
                ...
                <?php
                    ...
                    $sorgu = mysqli_query($conn , "Select * from uyeler where uye_id = '".$uye_id."'");
                ...
                if ($doldur['sifresıfırlamaistek'] == '1') {
                  ?>
                  <div style="max-width: 400px; margin-left: 450px;">
                  <form name="frmUser" method="post" action="" align="center">
                    <h2 align="center"><font color="#FF7F00">Şifremi Unuttum</font></h2>

                        <font color="#FF7F00">Şifre : </font>
                        <input type="password" name="sifre" id="sifre" required minlength='3' maxlength='21'><br><br>
                        <div style="margin-right: 50px;">
                        <font color="#FF7F00" >Tekrar Şifre : </font>
                        <input type="password" name="tsifre" id="tsifre" required minlength='3' maxlength='21'><br><br>
                        </div>
